...
const Footer: React.FC = () => {
  ...
  return (
    <footer  className=" z-50 flex    justify-center items-center m-auto  py-4 fixed bottom-0 w-full  max-md:flex-col  gap-4 bg-ethLime-500 text-ethGray-100 border-t-4 border-ethGray-500'">
   
      <div className='my-2'>
        <ul className='flex justify-center  items-center space-x-6 mt-6'>
          <li>
            <a
